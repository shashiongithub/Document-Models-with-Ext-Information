...
if __name__ == "__main__":
  ...
  validation_data = DataProcessor().prepare_news_data(vocab_dict, data_type="validation") # complete
  ...
  experiment = conn.experiments().create(
      ...
      parameters=[
          ...
          dict(name='log_learning_rate', type='double', bounds=dict(min=math.log(1e-6), max=math.log(1e-1))),
          dict(name='size'             , type='int'   , bounds=dict(min=100, max=3000)),
