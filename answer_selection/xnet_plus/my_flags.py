...
tf.app.flags.DEFINE_boolean("decorrelate_extra_feats", False, "Normalized [locisf,isf,idf] score.")

tf.app.flags.DEFINE_boolean("use_locisf", True, "Authorise Gold Label for JP's Model.")

tf.app.flags.DEFINE_boolean("use_isf", True, "Authorise Gold Label for JP's Model.")

tf.app.flags.DEFINE_boolean("use_idf", True, "Authorise Gold Label for JP's Model.")

### Training features

tf.app.flags.DEFINE_string("train_dir",
            "/disk/ocean/rcardenas/sidenet_att_extra/train_dir_newsqa",
            "Training directory.")

tf.app.flags.DEFINE_boolean("phase_train", True, "True only during training")

tf.app.flags.DEFINE_float("learning_rate", 0.001, "Learning rate.")

tf.app.flags.DEFINE_float("dropout", 0.65, "Dropout intensity.")

tf.app.flags.DEFINE_boolean("use_dropout", False, "Enable dropout")
...
tf.app.flags.DEFINE_string("pretrained_wordembedding_orgdata",
                           #"/disk/ocean/rcardenas/datasets/word_emb/1-billion-word-language-modeling-benchmark-r13output.word2vec.vec",
...
tf.app.flags.DEFINE_string("pretrained_wordembedding_anonymdata",
                           "/disk/ocean/rcardenas/datasets/word_emb/story-question_Anonymized.txt.word2vec.vec",
