...
def sentence_extractor_nonseqrnn_titimgatt(sents_ext, encoder_state, titleimages, isf_scores, idf_scores, locisf_scores):
...
def train_cross_entropy_loss(cross_entropy_loss):
    ...
    with tf.variable_scope('TrainCrossEntropyLoss') as scope:
        ...
        grads_to_summ = [tensor for tensor,var in grads_and_vars_capped_norm if tensor!=None]
